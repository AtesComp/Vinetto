...
store these thumbnails:
   ...
   reduce to a frame composition and image data.
      ...
      ***Vinetto may differ slightly from the original display of Type 1 thumbnails***.
      The Pillow library is used to attempt proper reconstruction.<br /><br />
      Analysis has shown that the stored JPEG portions describe CMY color
...
A local user Python environment can be used to install Vinetto for a user.
